...
// Composant : La chouette SVG assise dans un fauteuil, tenant un livre
    ...
    return (
        <div className="owl-wrap">
            <svg width="300" height="310" viewBox="0 0 300 310" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    {/* Dégradé radial pour le fauteuil (brun cuir) */}
                    ...
                    {/* Dégradé radial pour le corps de la chouette (bleu-gris) */}
                    ...
                    {/* Filtre SVG pour créer un contour noir épais autour des formes */}
                    ...
                    {/* Filtre SVG pour un contour noir plus fin (éléments secondaires) */}
                ...
                {/* Boutons capitonnés sur le dossier */}
